...
# I used PERP_AGE_GROUP because if the value is Unknown, that mean the case is not solved/ missing data
...
glm.fit <- glm(STATISTICAL_MURDER_FLAG ~ VIC_AGE_GROUP + VIC_RACE + VIC_SEX, data = shootingData, family = binomial)
summary(glm.fit)
```
